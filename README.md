...
- `.github/workflows/daily-repo-status.md` — agentic workflow that posts a daily repository status summary
- `.github/workflows/docs-refresh.md` — agentic workflow that keeps README files in sync with the code
- `.github/workflows/security-scan.md` — agentic workflow that scans for security issues
- `.github/workflows/weekly-research.md` — agentic workflow that performs weekly industry research scans
...
_Last reviewed by docs-refresh agent on 2026-05-21._
