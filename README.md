...
- `.github/workflows/security-scan.md` — agentic workflow that scans PRs for common security issues
- `.github/workflows/docs-refresh.md` — agentic workflow that keeps READMEs in sync with the code (runs every 2 days)
- `.github/workflows/daily-repo-status.md` — agentic workflow that posts a daily activity summary issue
- `.github/workflows/weekly-research.md` — agentic workflow that posts a weekly industry research discussion
...
_Last reviewed by docs-refresh agent on 2026-05-27._
