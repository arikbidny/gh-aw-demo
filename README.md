...
- `.github/workflows/docs-refresh.md` — agentic workflow that keeps READMEs accurate and aligned with the code (runs every 2 days)
- `.github/workflows/daily-repo-status.md` — agentic workflow that posts a daily repo status report as a GitHub issue
- `.github/workflows/security-scan.md` — agentic workflow that scans pull requests for common security issues
- `.github/workflows/weekly-research.md` — agentic workflow that posts a weekly industry research report as a GitHub Discussion
...
_Last reviewed by docs-refresh agent on 2026-05-15._
