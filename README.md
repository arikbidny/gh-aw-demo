...
- `.github/workflows/security-scan.md` — agentic workflow that reviews pull requests for security issues
- `.github/workflows/daily-repo-status.md` — agentic workflow that creates a daily repo status report as a GitHub issue
- `.github/workflows/docs-refresh.md` — agentic workflow that keeps READMEs in sync with the code
- `.github/workflows/weekly-research.md` — agentic workflow that generates a weekly industry research report as a GitHub Discussion
...
_Last reviewed by docs-refresh agent on 2026-06-07._
